...
function canTwoMoviesFillFlight(movieLengths, flightLength) {
  let movObj = {};
  for (let k of movieLengths) {
    let diff = flightLength - k;
    if (!!movObj[diff]) return true;
    movObj[k] = true;
  }
  return false;
}
...
// function canTwoMoviesFillFlight(movieLengths, flightLength) {
//   let movSet = new Set();
//   for (let movLen of movieLengths) {
//     let second = flightLength - movLen;
//     if (movSet.has(second)) return true;
//     movSet.add(movLen);
//   }
//   return false;
// }
